...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--classify_freqency', type=int, default=2000, help='frequency of saving the latest results')
        ...
        self.parser.add_argument('--epoch_count', type=int, default='1',help='which epoch to start? ')
